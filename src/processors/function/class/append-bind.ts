...
export const appendBind = (ctx: Context) => {
  ...
  content.toArray().forEach((item, i) => {
    ...
    listContent.push(new Item({ type: 'identifier', value: 'Bind', scope: scope2[0] }))
    listContent.push(new Item({ type: 'edge', value: 'call-start', scope: scope2[1] }))
    // Bind({}, this) - {} for λ context, this for ℓthis parameter
    listContent.push(new Item({ type: 'edge', value: 'object-start', scope: scope2[1] }))
    listContent.push(new Item({ type: 'edge', value: 'object-end', scope: scope2[1] }))
    listContent.push(new Item({ type: 'sign', value: ',', scope: scope2[1] }))
    listContent.push(new Item({ type: 'this', value: 'this', scope: scope2[1] }))
    listContent.push(new Item({ type: 'edge', value: 'call-end', scope: scope2[1] }))
  })
