...
module.exports = {
  ...
  rules: {
    ...
    '@typescript-eslint/no-empty-function': isProd ? 'error' : 'off',
    ...
    'react-hooks/exhaustive-deps': isProd ? 'error' : 'warn',
    'react/self-closing-comp': 'error',
    'require-await': isProd ? 'error' : 'warn'
  }
}